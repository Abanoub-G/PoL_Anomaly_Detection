...
def reduce_optical_flow_resolution(optical_flow_file_path, res_x, res_y):
  ...
  # print(num_of_rows_in_original)
  # print(num_of_columns_in_original)
  ...
  u_velocity_of_block_matrix = velocity_of_block_matrix[...,0]
  print(len(u_velocity_of_block_matrix))
  print(len(u_velocity_of_block_matrix[0]))
  u_max = velocity_of_block_matrix[...,0].max()
  u_min = velocity_of_block_matrix[...,0].min()
  # print("velocity_of_block_matrix[...,0]",velocity_of_block_matrix[...,0])
  print("u_min",u_min)
  result = np.where(u_velocity_of_block_matrix == np.amin(u_velocity_of_block_matrix))
  print(result)
  ...
  # u_min_ind = np.(u_velocity_of_block_matrix)#min(values))
  # print(u_min_ind)
  # print(u_velocity_of_block_matrix[u_min_ind])
  # ====================================================
  ...
  # get index of min velocity
  plt.imshow(velocity_of_block_matrix_normalised[...,2])
  plt.plot(cord[1],cord[0], marker='o', markersize=3, color="red")
  plt.colorbar()
  plt.show()
