...
def reduce_optical_flow_resolution(flownet_image_file_name, res_x, res_y):
...
def extract_optical_flow_section_of_detected_object(original_image, boxes, optical_flow_resultant):
