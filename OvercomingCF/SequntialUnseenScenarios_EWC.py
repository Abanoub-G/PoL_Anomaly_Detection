...
#   accumulating gradients
  for start in range(0, len(t_mem)-1, 64):
      end = start + 64
...
for i in range(0,20):
 ...
 for epoch in range(0, 50):
   model = train_ewc(model, device, i+1, x_train, t_train, optimizer, epoch, EWC_ON,1)
 on_task_update(i+1, x_train, t_train)
