...
for i in range(0,20):
 ...
 for epoch in range(0, E_list[best['E']]):
   model = train_ewc(model, device, i+1, x_train, t_train, optimizer, epoch, EWC_ON,best['lambda'],B_list[best['B']])
...
with open('NewInstanceCase1_EWCOp_Hyper_EachSet100', 'wb') as fp:
