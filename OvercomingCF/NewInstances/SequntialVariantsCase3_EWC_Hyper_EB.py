...
for i in range(number_sets):
 ...
 Y = []
 for j in range(10):
  X_temp,Y_temp = Varaints_By_Class[j]
  boundary = size_set/10
  
  boundary = int(boundary)
  X.append(X_temp[0:boundary])
  Y.append(Y_temp[0:boundary])
...
# copyed_model = copy.deepcopy(model)
 ...
 for epoch in range(0, e):   
  copyed_model = train_ewc(copyed_model, device, id_, x_train, t_train, optimizer, epoch,False,ewc_lambda,b)
...
with open('Case3_UserDefined', 'wb') as fp:
