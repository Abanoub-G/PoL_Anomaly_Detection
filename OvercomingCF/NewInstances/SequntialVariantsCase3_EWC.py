...
for i in range(number_sets):
 ...
 j_loop = int(size_set/10)
 for j in range(j_loop):
  for k in range(0,10):     
   X_temp,Y_temp = Varaints_By_Class[k]

   X.extend(X_temp[i*j_loop+j:i*j_loop+j+1])
   Y.extend(Y_temp[i*j_loop+j:i*j_loop+j+1])
...
with open('NewInstanceCase3_lr0.001_E5_B16_EachSet10_20Sets', 'wb') as fp:
